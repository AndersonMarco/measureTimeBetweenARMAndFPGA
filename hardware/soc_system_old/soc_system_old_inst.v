	soc_system_old u0 (
		...
		.pio_input10_external_connection_export  (<connected-to-pio_input10_external_connection_export>),  //  pio_input10_external_connection.export
		.pio_input11_external_connection_export  (<connected-to-pio_input11_external_connection_export>),  //  pio_input11_external_connection.export
		.pio_input12_external_connection_export  (<connected-to-pio_input12_external_connection_export>),  //  pio_input12_external_connection.export
		.pio_input13_external_connection_export  (<connected-to-pio_input13_external_connection_export>),  //  pio_input13_external_connection.export
		.pio_input14_external_connection_export  (<connected-to-pio_input14_external_connection_export>),  //  pio_input14_external_connection.export
		.pio_input15_external_connection_export  (<connected-to-pio_input15_external_connection_export>),  //  pio_input15_external_connection.export
		.pio_input16_external_connection_export  (<connected-to-pio_input16_external_connection_export>),  //  pio_input16_external_connection.export
		.pio_input2_external_connection_export   (<connected-to-pio_input2_external_connection_export>),   //   pio_input2_external_connection.export
		.pio_input3_external_connection_export   (<connected-to-pio_input3_external_connection_export>),   //   pio_input3_external_connection.export
		.pio_input4_external_connection_export   (<connected-to-pio_input4_external_connection_export>),   //   pio_input4_external_connection.export
		.pio_input5_external_connection_export   (<connected-to-pio_input5_external_connection_export>),   //   pio_input5_external_connection.export
		.pio_input6_external_connection_export   (<connected-to-pio_input6_external_connection_export>),   //   pio_input6_external_connection.export
		.pio_input7_external_connection_export   (<connected-to-pio_input7_external_connection_export>),   //   pio_input7_external_connection.export
		.pio_input8_external_connection_export   (<connected-to-pio_input8_external_connection_export>),   //   pio_input8_external_connection.export
		.pio_input9_external_connection_export   (<connected-to-pio_input9_external_connection_export>),   //   pio_input9_external_connection.export
		...
		.pio_output10_external_connection_export (<connected-to-pio_output10_external_connection_export>), // pio_output10_external_connection.export
		.pio_output11_external_connection_export (<connected-to-pio_output11_external_connection_export>), // pio_output11_external_connection.export
		.pio_output12_external_connection_export (<connected-to-pio_output12_external_connection_export>), // pio_output12_external_connection.export
		.pio_output13_external_connection_export (<connected-to-pio_output13_external_connection_export>), // pio_output13_external_connection.export
		.pio_output14_external_connection_export (<connected-to-pio_output14_external_connection_export>), // pio_output14_external_connection.export
		.pio_output15_external_connection_export (<connected-to-pio_output15_external_connection_export>), // pio_output15_external_connection.export
		.pio_output16_external_connection_export (<connected-to-pio_output16_external_connection_export>), // pio_output16_external_connection.export
		.pio_output2_external_connection_export  (<connected-to-pio_output2_external_connection_export>),  //  pio_output2_external_connection.export
		.pio_output3_external_connection_export  (<connected-to-pio_output3_external_connection_export>),  //  pio_output3_external_connection.export
		.pio_output4_external_connection_export  (<connected-to-pio_output4_external_connection_export>),  //  pio_output4_external_connection.export
		.pio_output5_external_connection_export  (<connected-to-pio_output5_external_connection_export>),  //  pio_output5_external_connection.export
		.pio_output6_external_connection_export  (<connected-to-pio_output6_external_connection_export>),  //  pio_output6_external_connection.export
		.pio_output7_external_connection_export  (<connected-to-pio_output7_external_connection_export>),  //  pio_output7_external_connection.export
		.pio_output8_external_connection_export  (<connected-to-pio_output8_external_connection_export>),  //  pio_output8_external_connection.export
		.pio_output9_external_connection_export  (<connected-to-pio_output9_external_connection_export>),  //  pio_output9_external_connection.export
