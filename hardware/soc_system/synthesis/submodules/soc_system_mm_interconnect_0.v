...
module soc_system_mm_interconnect_0 (
		...
		input  wire        led_output_reset_reset_bridge_in_reset_reset,                        //                        led_output_reset_reset_bridge_in_reset.reset
		output wire [1:0]  led_output_s1_address,                                               //                                                 led_output_s1.address
		output wire        led_output_s1_write,                                                 //                                                              .write
		input  wire [31:0] led_output_s1_readdata,                                              //                                                              .readdata
		output wire [31:0] led_output_s1_writedata,                                             //                                                              .writedata
		output wire        led_output_s1_chipselect,                                            //                                                              .chipselect
		output wire [1:0]  pio_input_s1_address,                                                //                                                  pio_input_s1.address
		input  wire [31:0] pio_input_s1_readdata                                                //                                                              .readdata
	);

	wire   [31:0] led_output_s1_agent_m0_readdata;                          // led_output_s1_translator:uav_readdata -> led_output_s1_agent:m0_readdata
	wire          led_output_s1_agent_m0_waitrequest;                       // led_output_s1_translator:uav_waitrequest -> led_output_s1_agent:m0_waitrequest
	wire          led_output_s1_agent_m0_debugaccess;                       // led_output_s1_agent:m0_debugaccess -> led_output_s1_translator:uav_debugaccess
	wire   [20:0] led_output_s1_agent_m0_address;                           // led_output_s1_agent:m0_address -> led_output_s1_translator:uav_address
	wire    [3:0] led_output_s1_agent_m0_byteenable;                        // led_output_s1_agent:m0_byteenable -> led_output_s1_translator:uav_byteenable
	wire          led_output_s1_agent_m0_read;                              // led_output_s1_agent:m0_read -> led_output_s1_translator:uav_read
	wire          led_output_s1_agent_m0_readdatavalid;                     // led_output_s1_translator:uav_readdatavalid -> led_output_s1_agent:m0_readdatavalid
	wire          led_output_s1_agent_m0_lock;                              // led_output_s1_agent:m0_lock -> led_output_s1_translator:uav_lock
	wire   [31:0] led_output_s1_agent_m0_writedata;                         // led_output_s1_agent:m0_writedata -> led_output_s1_translator:uav_writedata
	wire          led_output_s1_agent_m0_write;                             // led_output_s1_agent:m0_write -> led_output_s1_translator:uav_write
	wire    [2:0] led_output_s1_agent_m0_burstcount;                        // led_output_s1_agent:m0_burstcount -> led_output_s1_translator:uav_burstcount
	wire          led_output_s1_agent_rf_source_valid;                      // led_output_s1_agent:rf_source_valid -> led_output_s1_agent_rsp_fifo:in_valid
	wire  [112:0] led_output_s1_agent_rf_source_data;                       // led_output_s1_agent:rf_source_data -> led_output_s1_agent_rsp_fifo:in_data
	wire          led_output_s1_agent_rf_source_ready;                      // led_output_s1_agent_rsp_fifo:in_ready -> led_output_s1_agent:rf_source_ready
	wire          led_output_s1_agent_rf_source_startofpacket;              // led_output_s1_agent:rf_source_startofpacket -> led_output_s1_agent_rsp_fifo:in_startofpacket
	wire          led_output_s1_agent_rf_source_endofpacket;                // led_output_s1_agent:rf_source_endofpacket -> led_output_s1_agent_rsp_fifo:in_endofpacket
	wire          led_output_s1_agent_rsp_fifo_out_valid;                   // led_output_s1_agent_rsp_fifo:out_valid -> led_output_s1_agent:rf_sink_valid
	wire  [112:0] led_output_s1_agent_rsp_fifo_out_data;                    // led_output_s1_agent_rsp_fifo:out_data -> led_output_s1_agent:rf_sink_data
	wire          led_output_s1_agent_rsp_fifo_out_ready;                   // led_output_s1_agent:rf_sink_ready -> led_output_s1_agent_rsp_fifo:out_ready
	wire          led_output_s1_agent_rsp_fifo_out_startofpacket;           // led_output_s1_agent_rsp_fifo:out_startofpacket -> led_output_s1_agent:rf_sink_startofpacket
	wire          led_output_s1_agent_rsp_fifo_out_endofpacket;             // led_output_s1_agent_rsp_fifo:out_endofpacket -> led_output_s1_agent:rf_sink_endofpacket
	wire          led_output_s1_agent_rdata_fifo_src_valid;                 // led_output_s1_agent:rdata_fifo_src_valid -> led_output_s1_agent_rdata_fifo:in_valid
	wire   [33:0] led_output_s1_agent_rdata_fifo_src_data;                  // led_output_s1_agent:rdata_fifo_src_data -> led_output_s1_agent_rdata_fifo:in_data
	wire          led_output_s1_agent_rdata_fifo_src_ready;                 // led_output_s1_agent_rdata_fifo:in_ready -> led_output_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] pio_input_s1_agent_m0_address;                            // pio_input_s1_agent:m0_address -> pio_input_s1_translator:uav_address
	...
	wire  [112:0] pio_input_s1_agent_rf_source_data;                        // pio_input_s1_agent:rf_source_data -> pio_input_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] pio_input_s1_agent_rsp_fifo_out_data;                     // pio_input_s1_agent_rsp_fifo:out_data -> pio_input_s1_agent:rf_sink_data
	...
	wire          pio_input_s1_agent_rdata_fifo_src_valid;                  // pio_input_s1_agent:rdata_fifo_src_valid -> pio_input_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_input_s1_agent_rdata_fifo_src_data;                   // pio_input_s1_agent:rdata_fifo_src_data -> pio_input_s1_agent_rdata_fifo:in_data
	wire          pio_input_s1_agent_rdata_fifo_src_ready;                  // pio_input_s1_agent_rdata_fifo:in_ready -> pio_input_s1_agent:rdata_fifo_src_ready
	...
	wire          led_output_s1_agent_rp_valid;                             // led_output_s1_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] led_output_s1_agent_rp_data;                              // led_output_s1_agent:rp_data -> router_002:sink_data
	wire          led_output_s1_agent_rp_ready;                             // router_002:sink_ready -> led_output_s1_agent:rp_ready
	wire          led_output_s1_agent_rp_startofpacket;                     // led_output_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          led_output_s1_agent_rp_endofpacket;                       // led_output_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          pio_input_s1_agent_rp_valid;                              // pio_input_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] pio_input_s1_agent_rp_data;                               // pio_input_s1_agent:rp_data -> router_003:sink_data
	wire          pio_input_s1_agent_rp_ready;                              // router_003:sink_ready -> pio_input_s1_agent:rp_ready
	wire          pio_input_s1_agent_rp_startofpacket;                      // pio_input_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pio_input_s1_agent_rp_endofpacket;                        // pio_input_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> led_output_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> led_output_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // led_output_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> led_output_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> led_output_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> led_output_s1_burst_adapter:sink0_endofpacket
	wire          led_output_s1_burst_adapter_source0_valid;                // led_output_s1_burst_adapter:source0_valid -> led_output_s1_agent:cp_valid
	wire  [111:0] led_output_s1_burst_adapter_source0_data;                 // led_output_s1_burst_adapter:source0_data -> led_output_s1_agent:cp_data
	wire          led_output_s1_burst_adapter_source0_ready;                // led_output_s1_agent:cp_ready -> led_output_s1_burst_adapter:source0_ready
	wire    [1:0] led_output_s1_burst_adapter_source0_channel;              // led_output_s1_burst_adapter:source0_channel -> led_output_s1_agent:cp_channel
	wire          led_output_s1_burst_adapter_source0_startofpacket;        // led_output_s1_burst_adapter:source0_startofpacket -> led_output_s1_agent:cp_startofpacket
	wire          led_output_s1_burst_adapter_source0_endofpacket;          // led_output_s1_burst_adapter:source0_endofpacket -> led_output_s1_agent:cp_endofpacket
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> pio_input_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> pio_input_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // pio_input_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> pio_input_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> pio_input_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> pio_input_s1_burst_adapter:sink0_endofpacket
	wire          pio_input_s1_burst_adapter_source0_valid;                 // pio_input_s1_burst_adapter:source0_valid -> pio_input_s1_agent:cp_valid
	wire  [111:0] pio_input_s1_burst_adapter_source0_data;                  // pio_input_s1_burst_adapter:source0_data -> pio_input_s1_agent:cp_data
	wire          pio_input_s1_burst_adapter_source0_ready;                 // pio_input_s1_agent:cp_ready -> pio_input_s1_burst_adapter:source0_ready
	wire    [1:0] pio_input_s1_burst_adapter_source0_channel;               // pio_input_s1_burst_adapter:source0_channel -> pio_input_s1_agent:cp_channel
	wire          pio_input_s1_burst_adapter_source0_startofpacket;         // pio_input_s1_burst_adapter:source0_startofpacket -> pio_input_s1_agent:cp_startofpacket
	wire          pio_input_s1_burst_adapter_source0_endofpacket;           // pio_input_s1_burst_adapter:source0_endofpacket -> pio_input_s1_agent:cp_endofpacket
	...
	wire          led_output_s1_agent_rdata_fifo_out_valid;                 // led_output_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] led_output_s1_agent_rdata_fifo_out_data;                  // led_output_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          led_output_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> led_output_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> led_output_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> led_output_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // led_output_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> led_output_s1_agent:rdata_fifo_sink_error
	wire          pio_input_s1_agent_rdata_fifo_out_valid;                  // pio_input_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] pio_input_s1_agent_rdata_fifo_out_data;                   // pio_input_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          pio_input_s1_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_001:in_0_ready -> pio_input_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> pio_input_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> pio_input_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // pio_input_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> pio_input_s1_agent:rdata_fifo_sink_error
	...
	) led_output_s1_translator (
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (led_output_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_output_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (led_output_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (led_output_s1_agent_m0_read),                  //                         .read
		.uav_write              (led_output_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (led_output_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (led_output_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (led_output_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (led_output_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (led_output_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (led_output_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (led_output_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (led_output_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (led_output_s1_write),                          //                         .write
		.av_readdata            (led_output_s1_readdata),                       //                         .readdata
		.av_writedata           (led_output_s1_writedata),                      //                         .writedata
		.av_chipselect          (led_output_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (led_output_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (led_output_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (led_output_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (led_output_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (led_output_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (led_output_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (led_output_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (led_output_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (led_output_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (led_output_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (led_output_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (led_output_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (led_output_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (led_output_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (led_output_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (led_output_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (led_output_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (led_output_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (led_output_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (led_output_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (led_output_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (led_output_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (led_output_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (led_output_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (led_output_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (led_output_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (led_output_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (led_output_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (led_output_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (led_output_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (led_output_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (led_output_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (led_output_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (led_output_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_output_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (led_output_s1_agent_rdata_fifo_src_data),           //                .data
	...
	) led_output_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (led_output_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (led_output_s1_agent_rf_source_data),             //        in.data
		.in_valid          (led_output_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (led_output_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_output_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_output_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_output_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_output_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_output_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_output_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_output_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_output_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (led_output_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (led_output_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (led_output_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (led_output_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (led_output_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (led_output_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (led_output_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (pio_input_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_input_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_input_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_input_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_input_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_input_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_input_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (led_output_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_input_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (pio_input_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (pio_input_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (pio_input_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (pio_input_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (pio_input_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	soc_system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (led_output_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (led_output_s1_agent_rp_valid),                 //          .valid
		.sink_data          (led_output_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (led_output_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (led_output_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (led_output_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
	...
	) led_output_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                     //       cr0.clk
		.reset                 (led_output_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (led_output_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (led_output_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (led_output_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (led_output_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (led_output_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (led_output_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_input_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_input_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_input_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_input_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_input_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_input_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (led_output_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_output_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (led_output_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (led_output_s1_agent_rdata_fifo_out_ready),     //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (led_output_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_input_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (pio_input_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (pio_input_s1_agent_rdata_fifo_out_ready),      //         .ready
